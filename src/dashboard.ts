...
function companionFormHtml(): string {
  return `<form id="companionForm" onsubmit="handleSubmit(event)" class="p-6 space-y-5 overflow-y-auto">
    ...
    <div>
      ...
      <input type="text" id="inputName" required placeholder="e.g. Companion One" class="w-full bg-discord-input border border-white/10 rounded-lg px-3 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-discord">
    </div>
    <div>
